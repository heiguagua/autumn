...
DataVisitInfoService.service('DataVisitInfoService.dataVisitInfo', ['$http',
  function($http) {
...
ResourceCatalogController.controller('ResourceCatalogController.resourceCatalog', ['$scope',
  function($scope) {}
])
